package com.danielle.criminalintent
...
class CrimeFragment:Fragment(), DatePickerFragment.Callbacks {
        ...
        crimeDetailViewModel.crimeLiveData.observe(
            ...
            Observer { crime ->
                crime?.let {
                    ...
                    photoUri= FileProvider.getUriForFile(requireActivity(), "com.danielle.criminalIntent.fileprovider",
                    photoFile)
                    updateUI()
                }
            }
    ...
    private fun updatePhotoView() {
        if (photoFile.exists()) {
            Log.d(TAG, "get photo files")
            val bitmap = getScaledBitmap(photoFile.path, requireActivity())
            val description = bitmap.toString()
